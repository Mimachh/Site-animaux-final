                        ...
                        <div class="group border px-2 py-3 rounded shadow hover:shadow-lg">
                                        ...
                                        <a href="{{ route('annonces.show', $annonce) }}">
                                            ...
                                            <!-- Dispo -->
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <p class="text-sm text-gray-600 pb-3 pl-1">
                                                        Disponible du : <span class="text-md text-gray-800">{{$annonce->start_watch}}</span>  au : <span class="text-md text-gray-800">{{$annonce->end_watch}} </span>
                                                    </p>
                                                </div>
                                            <!-- Fin dispo --> 
                                            ...
                                            <div class="flex">
                                                ...
                                                <p class="text-sm text-gray-600 pl-1 pb-3"><span class="text-md text-gray-800"> Ville : {{ $ville }}</span></p>
                                            </div>
